...
(function ($) {
	$.cookieBubble = function (options) {
		...
		var cookiePolicyTarget = settings.cookiePolicyButtonTarget === '_blank' || settings.cookiePolicyButtonTarget === '_self' ? settings.cookiePolicyButtonTarget : settings.cookiePolicyButtonTarget;var cookiePolicyRel = settings.cookiePolicyButtonRel === 'noopener' || settings.cookiePolicyButtonRel === 'norefferer' ? settings.cookiePolicyButtonRel : settings.cookiePolicyButtonRel;
								...
								'<div class="cb-row">'+
									...
									'<div class="cb-row-content">'+
										...
										'<div class="cb-controls">'+
											...
											'<a class="cookie-policy-btn" href=' + settings.cookiePolicyButtonUrl + ' target=' + cookiePolicyTarget + ' rel=' + cookiePolicyRel +' >'
